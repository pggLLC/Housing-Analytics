...
Inventory (derived — run `node scripts/compute-inventory.mjs`): **54** top-level / **548** total HTML · **67** workflows · **268** client JS (**263** excl. `vendor/`) · **244** build/fetch scripts · **446** `docs/` markdown · **1650** data files · **546** geo-config rows / **546** unique geographies (**64** counties / **272** places / **210** CDPs) · **926** CHFA LIHTC features.
