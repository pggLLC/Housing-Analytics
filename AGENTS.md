...
Inventory (derived — run `node scripts/compute-inventory.mjs`): **54** top-level / **548** total HTML · **67** workflows · **267** client JS (**262** excl. `vendor/`) · **240** build/fetch scripts · **496** `docs/` markdown · **1648** data files · **547** geo-config rows / **546** unique geographies (**64** counties / **273** places / **210** CDPs) · **926** CHFA LIHTC features.
