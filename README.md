...
Current tracked inventory: **53 top-level / 547 total HTML pages**, **67 workflows**, **259 JavaScript files under `js/`**, and **547 geographies** (**64 counties / 273 places / 210 CDPs**).
