...
Current tracked inventory: **62 top-level / 556 total HTML pages**, **71 workflows**, **276 JavaScript files under `js/`**, and **546 geographies** (**64 counties / 272 places / 210 CDPs**).
