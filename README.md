...
Current tracked inventory: **63 top-level / 557 total HTML pages**, **71 workflows**, **284 JavaScript files under `js/`**, and **546 geographies** (**64 counties / 272 places / 210 CDPs**).
