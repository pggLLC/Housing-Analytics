...
Current tracked inventory: **61 top-level / 555 total HTML pages**, **71 workflows**, **275 JavaScript files under `js/`**, and **546 geographies** (**64 counties / 272 places / 210 CDPs**).
