...
Current tracked inventory: **54 top-level / 548 total HTML pages**, **67 workflows**, **270 JavaScript files under `js/`**, and **546 geographies** (**64 counties / 272 places / 210 CDPs**).
