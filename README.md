...
Current tracked inventory: **59 top-level / 553 total HTML pages**, **68 workflows**, **275 JavaScript files under `js/`**, and **546 geographies** (**64 counties / 272 places / 210 CDPs**).
