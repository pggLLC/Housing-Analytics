...
- **Relevance to Fruita/Grand Valley:** the Fruita + Grand Junction + Mesa County market is regional (see the Fruita Mews PMA calibration, `docs/audits/CALIBRATION-FRUITA-MEWS-PMA-2026-07.md`). A Grand Valley multijurisdictional authority (or a GJHA/Mesa County partnership) would bring taxing and scale a single small-town authority cannot.
