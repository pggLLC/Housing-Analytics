...
The constants above were benchmarked against EPS "Regional Housing Needs Assessment -- Draft Phase II Report" (June 16, 2026, EPS #243156) before the ownership roadmap advanced beyond the initial screening layer. See `internal/docs/audits/OWNERSHIP-BENCHMARK-EPS-PHASE2-2026-07.md`.
