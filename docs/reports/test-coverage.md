...
_Auto-generated 2026-09-17 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `test/acs-etl.test.js` | `acs-etl` | 532 | 139 |
| `test/pma-scoring.test.js` | `pma-scoring` | 706 | 135 |
| `test/integration/analytics.test.js` | `analytics` | 334 | 111 |
| `test/jurisdiction-metrics-digest.test.js` | `jurisdiction-metrics-digest` | 539 | 103 |
...
| `test/hna-home-value-cascade.test.js` | `hna-home-value-cascade` | 200 | 57 |
...
| `test/market-study-report.test.js` | `market-study-report` | 161 | 47 |
...
| `test/chfa-dda-qct-absence.test.js` | `chfa-dda-qct-absence` | 264 | 43 |
...
| `test/hna-phase2-stubs-wired.test.js` | `hna-phase2-stubs-wired` | 144 | 34 |
...
| `test/hna-section-rail.test.js` | `hna-section-rail` | 165 | 31 |
...
| `test/deal-calc-minimum-set-aside.test.js` | `deal-calc-minimum-set-aside` | 135 | 28 |
...
| `test/hmda-trend-and-chas-badge.test.js` | `hmda-trend-and-chas-badge` | 113 | 27 |
...
| `test/site-review-build-pause-regressions.test.js` | `site-review-build-pause-regressions` | 232 | 24 |
...
| `test/console-audit-exercises-controls.test.js` | `console-audit-exercises-controls` | 157 | 22 |
...
| `test/ranking-index-augmentation-present.test.js` | `ranking-index-augmentation-present` | 193 | 21 |
...
| `test/cost-per-sf-absence.test.js` | `cost-per-sf-absence` | 152 | 19 |
| `test/county-from-coords.test.js` | `county-from-coords` | 148 | 19 |
| `test/deal-calc-absence-semantics.test.js` | `deal-calc-absence-semantics` | 202 | 19 |
| `test/deal-calc-ami-bands.test.js` | `deal-calc-ami-bands` | 149 | 19 |
| `test/fred-commodities-config.test.js` | `fred-commodities-config` | 108 | 19 |
| `test/freshness-guard-dirty-tree.test.js` | `freshness-guard-dirty-tree` | 291 | 19 |
...
| `test/basemap-honours-tilelayer-contract.test.js` | `basemap-honours-tilelayer-contract` | 134 | 15 |
| `test/hna-jurisdiction-normalization.test.js` | `hna-jurisdiction-normalization` | 162 | 15 |
| `test/hna-sub-county-and-sync.test.js` | `hna-sub-county-and-sync` | 99 | 15 |
...
| `test/car-estimate-disclosure.test.js` | `car-estimate-disclosure` | 175 | 14 |
| `test/file-manifest.test.js` | `file-manifest` | 96 | 14 |
| `test/lihtc-guide-accuracy.test.js` | `lihtc-guide-accuracy` | 48 | 14 |
| `test/parcel-source-honesty.test.js` | `parcel-source-honesty` | 114 | 14 |
| `test/pma-map-integrity.test.js` | `pma-map-integrity` | 36 | 14 |
| `test/policy-data-currency.test.js` | `policy-data-currency` | 46 | 14 |
...
| `test/deal-calculator-glossary.test.js` | `deal-calculator-glossary` | 85 | 12 |
| `test/hna-county-scope-disclosures.test.js` | `hna-county-scope-disclosures` | 100 | 12 |
...
| `test/hna-home-value-absence.test.js` | `hna-home-value-absence` | 107 | 11 |
...
| `test/acs-vintage-label-integrity.test.js` | `acs-vintage-label-integrity` | 88 | 0 |
| `test/affordability-defaults-inventory.test.js` | `affordability-defaults-inventory` | 160 | 0 |
| `test/ci-verifies-bot-commits.test.js` | `ci-verifies-bot-commits` | 125 | 0 |
| `test/county-demographics-contract.test.js` | `county-demographics-contract` | 376 | 0 |
| `test/deal-calc-studio-units.test.js` | `deal-calc-studio-units` | 65 | 0 |
...
| `test/hna-view-content-parity.test.js` | `hna-view-content-parity` | 147 | 0 |
| `test/hud-egis.test.js` | `hud-egis` | 508 | 0 |
| `test/map-container-resize.test.js` | `map-container-resize` | 75 | 0 |
| `test/notify-cancelled-outcome.test.js` | `notify-cancelled-outcome` | 79 | 0 |
| `test/paper-figures-fresh.test.js` | `paper-figures-fresh` | 433 | 0 |
| `test/place-chas-method-honesty.test.js` | `place-chas-method-honesty` | 191 | 0 |
| `test/pma-flood-absence.test.js` | `pma-flood-absence` | 95 | 0 |
| `test/public-config-no-secrets.test.js` | `public-config-no-secrets` | 102 | 0 |
| `test/ranking-index-no-coerced-zeros.test.js` | `ranking-index-no-coerced-zeros` | 133 | 0 |
| `test/rendered-absence-not-zero.test.js` | `rendered-absence-not-zero` | 91 | 0 |
| `test/required-fetch-preserves-data.test.js` | `required-fetch-preserves-data` | 129 | 0 |
| `test/smoke-f139.test.js` | `smoke-f139` | 198 | 0 |
| `test/smoke-fmr.test.js` | `smoke-fmr` | 297 | 0 |
| `test/test-reachability.test.js` | `test-reachability` | 143 | 0 |
| `test/unit-suffix-convention.test.js` | `unit-suffix-convention` | 176 | 0 |
| `test/unwired-suite.test.js` | `unwired-suite` | 263 | 0 |
| `test/wcag-pill-contrast.test.js` | `wcag-pill-contrast` | 265 | 0 |
| `test/workflow-outcome-monitor.test.js` | `workflow-outcome-monitor` | 975 | 0 |
...
| `tests/test_hna_ranking_integrity.py` | `hna_ranking_integrity.py` | 522 | 47 |
| `tests/test_stage3_visualization.py` | `stage3_visualization.py` | 520 | 47 |
| `tests/test_fetch_regrid_pipeline_parcels.py` | `fetch_regrid_pipeline_parcels.py` | 211 | 44 |
| `tests/test_fmr_parsing.py` | `fmr_parsing.py` | 195 | 28 |
...
| `tests/test_acs_vintage_var_aliases.py` | `acs_vintage_var_aliases.py` | 98 | 12 |
| `tests/test_build_hna_data_concurrency.py` | `build_hna_data_concurrency.py` | 221 | 12 |
