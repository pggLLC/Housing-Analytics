...
_Auto-generated 2026-06-29 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `test/hna-home-value-cascade.test.js` | `hna-home-value-cascade` | 43 | 10 |
