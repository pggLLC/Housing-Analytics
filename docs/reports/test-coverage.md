...
_Auto-generated 2026-06-22 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `test/developer-geoids.test.js` | `developer-geoids` | 147 | 0 |
| `test/hna-acs-var-coverage.test.js` | `hna-acs-var-coverage` | 76 | 0 |
