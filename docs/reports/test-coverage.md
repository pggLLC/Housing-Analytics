...
_Auto-generated 2026-05-04 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `test/unit/site-selection-score.test.js` | `site-selection-score` | 575 | 84 |
