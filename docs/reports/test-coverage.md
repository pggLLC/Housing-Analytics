...
_Auto-generated 2026-06-30 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `tests/test_hna_ranking_integrity.py` | `hna_ranking_integrity.py` | 474 | 45 |
