...
_Auto-generated 2026-08-10 by `scripts/generate-test-coverage.mjs` (weekly via `docs-sync.yml`)._
...
| `test/public-facing-numbers.test.js` | `public-facing-numbers` | 69 | 21 |
...
| `test/pma-methodology-language.test.js` | `pma-methodology-language` | 78 | 18 |
...
| `test/pipeline-guards-a2.test.js` | `pipeline-guards-a2` | 127 | 16 |
...
| `test/geo-config-county-consistency.test.js` | `geo-config-county-consistency` | 50 | 3 |
| `test/metric-semantics-wording.test.js` | `metric-semantics-wording` | 64 | 3 |
...
| `test/cross-surface-vintage-labels.test.js` | `cross-surface-vintage-labels` | 93 | 2 |
