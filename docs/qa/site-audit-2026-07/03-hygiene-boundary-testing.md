...
| C-07 | P2 | Public/internal boundary was mixed during this audit. Developer pages were gated, while public pages contained pipeline teasers and repo docs exposed internal work-order history. | `developer.html:9`; `developer-brief.html:1233-1317`; `compare.html:36-37`; `market-analysis.html:2188-2266`; `docs/qa/*`; owner-local engineering archives. | Keep operational engineering archives out of the public build/docs index. |
