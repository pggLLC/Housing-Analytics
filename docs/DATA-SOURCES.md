...
> **📋 Note:** For the authoritative data source catalog, see [`SITE_AUDIT_GIS.md`](SITE_AUDIT_GIS.md). This file documents operational API secrets, CI workflow schedules, and data file inventory.
