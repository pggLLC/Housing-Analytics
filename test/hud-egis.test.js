...
// ─── 6. checkDesignation return shape ────────────────────────────────────────
// Verify the expected return shape { in_qct, in_dda, basis_boost_eligible }.
console.log('\n── 6. checkDesignation() return shape (source analysis) ──');

var srcStr = fs.existsSync(SRC) ? fs.readFileSync(SRC, 'utf8') : '';
