...
const SLA_CONFIG = [
  ...
  { file: 'data/co_chas_by_place.json',                     slaDays: 9,   cadence: 'weekly (build-hna-data.yml Phase 6.7)' },
  { file: 'data/market/chas_co_tract.json',                 slaDays: 400, cadence: 'annual (HUD CHAS release)' },
];
