...
# Candidate years, newest first.  We look back 5 years from the current
# year to stay robust across data vintage releases without ever pointing
# at a year in the future.
_CURRENT_YEAR = datetime.now(timezone.utc).year
_CANDIDATE_YEARS = list(range(_CURRENT_YEAR - 1, _CURRENT_YEAR - 6, -1))
