...
{{PLACE_JSON_LD}}
  ...
  <style>
    ...
    .place-grid { max-width: var(--page-max, 1920px); margin: 1.5rem auto; padding: 0 1.5rem; display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem; }
