...
(function () {
  ...
  var SOURCES = [
    ...
    },
    {
      ...
      provider: 'HUD / Internal',
      url: null,
      localFile: 'data/co_ami_gap_by_county.json',
      ...
      coverage: 'Colorado — 64 counties',
      features: 64,
      description: 'AMI gap analysis: difference between area median income and affordable rent threshold by county.',
      tags: ['ami', 'affordability', 'gap', 'county'],
      apiEndpoint: null
    },
    {
