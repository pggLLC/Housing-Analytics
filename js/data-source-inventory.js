...
(function () {
  ...
  var SOURCES = [
    ...
    },
    {
      ...
      localFile: 'data/market/SYNTHETIC_cde_schools_co.json',
      lastUpdated: '2026-09-09',
      updateFrequency: 'Annual',
      maxAgeDays: 400,
      geoUnit: 'Point',
      coverage: 'Colorado statewide',
      features: 30,
      description: 'Synthetic CDE school fixture retained for reference and non-production testing. It is excluded from production PMA scoring.',
    ...
    },
    {
      ...
      localFile: 'data/market/SYNTHETIC_cdle_job_postings_co.json',
      lastUpdated: '2026-09-09',
      ...
      coverage: 'Colorado statewide',
      features: 62,
      description: 'Synthetic CDLE job-postings fixture retained for reference and non-production testing. It is excluded from production PMA scoring.',
    ...
    },
    {
      ...
      localFile: 'data/market/SYNTHETIC_cdot_traffic_co.json',
      lastUpdated: '2026-09-09',
      updateFrequency: 'Annual',
      maxAgeDays: 400,
      ...
      coverage: 'Colorado statewide',
      features: 40,
      description: 'Synthetic CDOT traffic fixture retained for reference and non-production testing. It is excluded from production PMA scoring.',
