...
(function () {
  ...
  function renderStep(s) {
    ...
    if (Array.isArray(s.buckets) && s.buckets.length) {
      ...
      subHeader.innerHTML =
        '<strong>Public boundary:</strong> these buckets explain the framework. ' +
        'Jurisdiction-specific classifications and outreach status are internal review materials.';
