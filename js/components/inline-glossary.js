...
(function (global) {
  ...
  var TERMS = {
    ...
    'B19001': 'ACS table B19001 — household income distribution (all tenures). Retained as the AMI-gap model\'s legacy all-household series and population proxy.',
    'B25118': 'ACS table B25118 — tenure by household income. The renter-household bins are the AMI-gap model\'s demand side: renter households at each AMI band.',
