...
(function(){
  ...
  function renderEmploymentTrend(geoid) {
    ...
    if (!lehd || !lehd.annualEmployment) {
      container.innerHTML = '<p style="color:var(--muted);font-size:.9rem">Trend charts require WAC-enriched LEHD county files (including annual employment, wages, and industries). Run the HNA data build workflow to populate the data.<br><code style="font-size:.8rem">python3 scripts/hna/build_hna_data.py</code></p>';
      return;
    }
  ...
  function renderEconomicIndicators(geoid) {
    ...
    if (wacMissing) {
      ...
      var fallbackMsg = '<p class="metric-cards-note" style="padding:.75rem 0">Trend charts require WAC-enriched LEHD county files (including annual employment, wages, and industries). Run the HNA data build workflow to populate the data.<br><code style="font-size:.8rem">python3 scripts/hna/build_hna_data.py</code></p>';
      if (sectionEl) {
