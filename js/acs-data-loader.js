...
(function (global) {
  ...
  var ACS_FIELD_MAPPING = {
    DP04: {
      ...
      DP04_0137PE: { name: 'grapi_lt15',              type: 'percentage', description: 'Gross rent < 15% of income' },
      DP04_0138PE: { name: 'grapi_15_19',             type: 'percentage', description: 'Gross rent 15-19.9%' },
      DP04_0139PE: { name: 'grapi_20_24',             type: 'percentage', description: 'Gross rent 20-24.9%' },
      DP04_0140PE: { name: 'grapi_25_29',             type: 'percentage', description: 'Gross rent 25-29.9%' },
      DP04_0141PE: { name: 'grapi_30_34',             type: 'percentage', description: 'Gross rent 30-34.9%' },
      DP04_0142PE: { name: 'grapi_35_plus',           type: 'percentage', description: 'Gross rent 35%+' },
      DP04_0143PE: { name: 'grapi_not_computed',      type: 'percentage', description: 'Gross rent not computed' },
